...
public class PiiMaskingPostProcessor implements DocumentPostProcessor {

    private static final Logger LOGGER = LoggerFactory.getLogger(PiiMaskingPostProcessor.class);
    ...
    public static PiiMaskingPostProcessor builder() {
        return new PiiMaskingPostProcessor();
    }
}
